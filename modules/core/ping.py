...
LANGUAGES = {
    "en": {
        ...
        "text_return": """<emoji id='5269563867305879894'>🏓</emoji> Pong <emoji id='5783105032350075795'>📶</emoji> {ping} ms {connect}"""
    },
    "ru": {
        ...
        "text_return": """<emoji id='5269563867305879894'>🏓</emoji> Понг <emoji id='5783105032350075795'>📶</emoji> {ping} мс {connect}"""
    },
}
